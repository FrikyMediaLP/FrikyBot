...
function createEdit(x) {
    ...
    //ExitButton
    options += "<div id='ExitButton' onclick='exitEDITINFO()'><center>X</center></div>"
        ...
        Other: {
            versions: {
                1: {
                    ...
                    image_url_1x: TEMP_SRC + "Other.png",
                    image_url_2x: TEMP_SRC + "Other.png",
                    image_url_4x: TEMP_SRC + "Other.png",
                    last_updated: null,
                    click_action: "none",
                    click_url: ""
                }
        ...
        Unknown: {
            versions: {
                1: {
                    ...
                    image_url_1x: TEMP_SRC + "Unknown.png",
                    image_url_2x: TEMP_SRC + "Unknown.png",
                    image_url_4x: TEMP_SRC + "Unknown.png",
                    last_updated: null,
                    click_action: "none",
                    click_url: ""
                }
        ...
        Follower: {
            versions: {
                1: {
                    ...
                    image_url_1x: TEMP_SRC + "Follow.png",
                    image_url_2x: TEMP_SRC + "Follow.png",
                    image_url_4x: TEMP_SRC + "Follow.png",
                    last_updated: null,
                    click_action: "none",
                    click_url: ""
                }
        ...
        Regular: {
            versions: {
                1: {
                    ...
                    image_url_1x: TEMP_SRC + "Regular.png",
                    image_url_2x: TEMP_SRC + "Regular.png",
                    image_url_4x: TEMP_SRC + "Regular.png",
                    last_updated: null,
                    click_action: "none",
                    click_url: ""
                }
