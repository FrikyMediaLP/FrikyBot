...
IconSelect.DEFAULT = {};
IconSelect.DEFAULT.SELECTED_ICON_WIDTH = 20;			//[CHANGED]
IconSelect.DEFAULT.SELECTED_ICON_HEIGHT = 20;			//[CHANGED]
IconSelect.DEFAULT.SELECTED_BOX_PADDING = 1;
IconSelect.DEFAULT.SELECTED_BOX_PADDING_RIGHT = 1;		//[CHANGED]
IconSelect.DEFAULT.ICONS_WIDTH = 18;					//[CHANGED]
IconSelect.DEFAULT.ICONS_HEIGHT = 18;					//[CHANGED]
IconSelect.DEFAULT.BOX_ICON_SPACE = 3;
IconSelect.DEFAULT.HORIZONTAL_ICON_NUMBER = 3;
IconSelect.DEFAULT.VECTORAL_ICON_NUMBER = 3;

IconSelect.COMPONENT_ICON_FILE_PATH = "scripts/libraries/IconSelect/arrow.png";

function IconSelect($$elementID, $$parameters, onChange) {	//[ADDED] OnChange Method
    
    var _icons = [];
    var _selectedIndex = -1;
    var _boxScroll;
    var _default = IconSelect.DEFAULT;
	var _last = -1;						//[ADDED] For OnChange detection - no double firing
    ...
    function _init() {
        ...
        if(_View.setIconSelectElement($$elementID)){
            ...
            _View.iconSelectElement.addEventListener('click', function($event){
				...
				//[ADDED] OnChange method to detect changes in selection
				if(_last != _selectedIndex) {
					_last = _selectedIndex;
					onChange(_selectedIndex != -1 ? _icons[_selectedIndex] : null);		
				}					
            });
